...
export class SmartSearchService {
  ...
  listOfBranches(req?: any){
    ...
    return this.http.post('https://c3cwmli2ne.execute-api.us-east-1.amazonaws.com/equeue/api/list-of-branches-map', req, { headers: this.httpOptions, observe: 'response' }).pipe(map(
      response => {
